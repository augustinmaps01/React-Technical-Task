...
const myFighter1 = new Fighter({name: 'Maximus', damage: 20, strength: 20, agility: 15,vitality: 60, hp: 100});
const myFighter2 = new Fighter({name: 'Comodus', damage: 25, strength: 25, agility: 20, vitality: 40, hp: 90});
let name = myFighter1.getName();
console.log(name);
